    ...
    public function run(): void
    {
        ...
        $projects = [
            ...
            [
                ...
                'short_description' => 'A modern social media application with real-time messaging, stories, and content sharing.',
                'description' => "Created a social media platform featuring real-time messaging, story sharing, content feeds with infinite scrolling, and a recommendation engine. The app supports media uploads, live streaming, and push notifications.\n\nArchitected with React Native for cross-platform mobile support and Node.js with Socket.io for real-time communication.",
            ...
            [
                ...
                'short_description' => 'A collaborative project management tool with Kanban boards, time tracking, and team workflows.',
                'description' => "Developed a comprehensive project management suite featuring Kanban boards, Gantt charts, time tracking, team collaboration tools, and automated workflows. Supports integrations with Slack, GitHub, and Jira.\n\nBuilt with Vue.js frontend and Laravel backend, featuring real-time collaboration via WebSockets.",
            ...
            [
                ...
                'short_description' => 'A secure payment processing gateway with multi-currency support and fraud detection.',
                'description' => "Engineered a PCI-compliant payment gateway supporting multiple currencies, payment methods, and real-time fraud detection using ML algorithms. Features include recurring billing, subscription management, and detailed financial reporting.\n\nBuilt with a focus on security, using encryption at rest and in transit, with comprehensive audit logging.",
                'technologies' => ['Node.js', 'TypeScript', 'PostgreSQL', 'Stripe', 'AWS Lambda'],
                'category' => 'web',
                'is_featured' => false,
                'live_url' => 'https://example.com',
                'github_url' => 'https://github.com',
            ...
            [
                ...
                'short_description' => 'A comprehensive health tracking app with workout plans, nutrition logging, and progress analytics.',
                'description' => "Built a health and fitness application that tracks workouts, nutrition, sleep patterns, and overall wellness metrics. Features personalized workout plans, meal planning, progress charts, and social features for community challenges.\n\nDeveloped with React Native for iOS and Android, with a Node.js backend and real-time sync across devices.",
                'technologies' => ['React Native', 'Node.js', 'MongoDB', 'GraphQL', 'HealthKit'],
                'category' => 'mobile',
                'is_featured' => false,
                'live_url' => 'https://example.com',
                'github_url' => 'https://github.com',
