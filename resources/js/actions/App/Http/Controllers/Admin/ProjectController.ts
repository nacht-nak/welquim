 ...
 * @see app/Http/Controllers/Admin/ProjectController.php:16
...
/**
* @see \App\Http\Controllers\Admin\ProjectController::create
 * @see app/Http/Controllers/Admin/ProjectController.php:23
 ...
 * @see app/Http/Controllers/Admin/ProjectController.php:28
 * @route '/admin/projects'
 */
...
/**
* @see \App\Http\Controllers\Admin\ProjectController::show
 * @see app/Http/Controllers/Admin/ProjectController.php:0
 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\Admin\ProjectController::edit
 * @see app/Http/Controllers/Admin/ProjectController.php:58
 * @route '/admin/projects/{project}/edit'
 */
export const edit = (args: { project: string | { slug: string } } | [project: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/admin/projects/{project}/edit'
 */
edit.url = (args: { project: string | { slug: string } } | [project: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { project: args }
    }
 ...
 * @route '/admin/projects/{project}/edit'
 */
edit.get = (args: { project: string | { slug: string } } | [project: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: edit.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/admin/projects/{project}/edit'
 */
edit.head = (args: { project: string | { slug: string } } | [project: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: edit.url(args, options),
    method: 'head',
})
 ...
 * @route '/admin/projects/{project}/edit'
 */
    const editForm = (args: { project: string | { slug: string } } | [project: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/admin/projects/{project}/edit'
 */
        editForm.get = (args: { project: string | { slug: string } } | [project: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: edit.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin/projects/{project}/edit'
 */
        editForm.head = (args: { project: string | { slug: string } } | [project: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @see app/Http/Controllers/Admin/ProjectController.php:65
 * @route '/admin/projects/{project}'
 */
 ...
 * @see app/Http/Controllers/Admin/ProjectController.php:96
 * @route '/admin/projects/{project}'
 */
