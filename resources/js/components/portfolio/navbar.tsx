...
export default function Navbar() {
    ...
    return (
        ...
        >
            ...
            {/* Mobile Menu */}
            <div
                className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out ${isOpen ? 'max-h-80 border-b border-white/10 dark:border-white/5 bg-background/95 glass' : 'max-h-0'
                    }`}
            >
