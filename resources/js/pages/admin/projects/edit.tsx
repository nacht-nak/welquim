...
export default function EditProject({ project }: EditProps) {
    const { data, setData, post, transform, processing, errors } = useForm({
        ...
        tech_input: project.technologies ? project.technologies.join(', ') : '',
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // Laravel requires POST with _method = PUT for file uploads via PUT
    ...
    return (
        <>
            <Head title={`Edit Project: ${project.title} - Portfolio Admin`} />
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                {project.image && (
                                    <p className="text-xs text-muted-foreground mt-1">Current file: {project.image}</p>
                                )}
